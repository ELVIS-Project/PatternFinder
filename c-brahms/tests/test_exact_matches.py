...
class CBRAHMSTestExactMatches(TestCase):
    ...
    def setUp(self):
        ...
        self.P2 = partial(cbrahmsGeo.P2, mismatch = 0)
    ...
    def test_P1_edgecase_identical_source(self):
        ...
        list_of_shifts = self.P1(self.pattern, source)
    ...
    def test_P1_midiparser_chidori(self):
        list_of_shifts = tools.run_algorithm_with_midiparser(self.P1, 'music_files/chidori_query.mid', 'music_files/chidori_meimei.mid')
        self.assertEqual(list_of_shifts, [[2.0, -10], [6.0, -10], [65.0, -10], [69.0, -10]])
    def test_P2_midiparser_chidori(self):
        list_of_shifts = tools.run_algorithm_with_midiparser(self.P2, 'music_files/chidori_query.mid', 'music_files/chidori_meimei.mid')
        self.assertEqual(list_of_shifts, [[2.0, -10], [6.0, -10], [65.0, -10], [69.0, -10]])
    ...
    def test_P1_midiparser_bwv2(self):
        list_of_shifts = tools.run_algorithm_with_midiparser(self.P1, 'music_files/query_V-i.mid', 'music_files/bach_BWV2_chorale.krn')
        self.assertEqual(list_of_shifts, [[30.0, 0]])
    def test_P2_midiparser_bwv2(self):
        list_of_shifts = tools.run_algorithm_with_midiparser(self.P2, 'music_files/query_V-i.mid', 'music_files/bach_BWV2_chorale.krn')
        self.assertEqual(list_of_shifts, [[30.0, 0]])
