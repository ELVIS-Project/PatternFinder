...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>&lt;no title&gt; &mdash; music21 Documentation</title>
...
<script type="text/javascript">$('#searchbox').show(0);</script>
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/usersGuide/usersGuide_96_ipython_comm.txt"
  ...
  <span class="target" id="usersguide-96-ipython-comm"></span> <script src='http://web.mit.edu/music21/music21j/ext/require/require.js'></script>
 <script>
require.config(
...
</script><div class="code python highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">music21</span> <span class="kn">import</span> <span class="o">*</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">IPython.display</span> <span class="kn">import</span> <span class="n">HTML</span><span class="p">,</span> <span class="n">Javascript</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">m21url</span> <span class="o">=</span> <span class="s">&quot;http://web.mit.edu/music21/music21j/src/music21.js&quot;</span>

<span class="k">def</span> <span class="nf">Javas</span><span class="p">(</span><span class="n">msg</span><span class="p">,</span> <span class="n">lib</span><span class="o">=</span><span class="bp">None</span><span class="p">):</span>
    <span class="k">pass</span>

<span class="n">Javas</span><span class="p">(</span><span class="s">&#39;console.log(&quot;m&quot;, music21);&#39;</span><span class="p">,</span> <span class="n">lib</span><span class="o">=</span><span class="p">[</span><span class="n">m21url</span><span class="p">])</span>
<span class="n">HTML</span><span class="p">(</span><span class="s">&#39;&#39;&#39;</span>
<span class="s">&lt;script&gt;</span>
<span class="s">require.config(</span>
<span class="s">   { baseUrl: &quot;http://web.mit.edu/music21/music21j/src/&quot;,</span>
<span class="s">     paths: {&#39;music21&#39;: &#39;http://web.mit.edu/music21/music21j/src/music21&#39;,}</span>
<span class="s">    });</span>
<span class="s">console.log(&#39;hi&#39;);</span>
<span class="s">  require([&#39;music21&#39;], function () {</span>
<span class="s">      console.log(&#39;hey!&#39;);</span>
<span class="s">      var n = new music21.note.Note(&quot;D#4&quot;);</span>
<span class="s">      var s = new music21.stream.Stream();</span>
<span class="s">      s.append(n);</span>

<span class="s">      s.appendNewCanvas($(&#39;.output_subarea.output_html.rendered_html.output_pyout&#39;)[0]);</span>
<span class="s">  });</span>
<span class="s">&lt;/script&gt;</span>
...
</script><div class="code python highlight-python"><div class="highlight"><pre><span class="n">nn</span> <span class="o">=</span> <span class="n">note</span><span class="o">.</span><span class="n">Note</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">vfp</span> <span class="o">=</span> <span class="n">vexflow</span><span class="o">.</span><span class="n">toMusic21j</span><span class="o">.</span><span class="n">VexflowPickler</span><span class="p">()</span>
<span class="n">vfp</span><span class="o">.</span><span class="n">mode</span> <span class="o">=</span> <span class="s">&#39;json&#39;</span>

<span class="c"># Example from http://jakevdp.github.io/blog/2013/06/01/ipython-notebook-javascript-python-communication/ adapted for IPython 2.0</span>
<span class="c"># Add an input form similar to what we saw above</span>
<span class="n">input_form</span> <span class="o">=</span> <span class="s">&quot;&quot;&quot;</span>
<span class="s">&lt;div id=&quot;heya&quot; style=&quot;background-color:gainsboro; border:solid black; width:600px; padding:20px;&quot;&gt;</span>
<span class="s">Code: &lt;input type=&quot;text&quot; id=&quot;code_input&quot; size=&quot;50&quot; height=&quot;2&quot;</span>
<span class="s">       value=&quot;corpus.parse(&#39;bwv66.6&#39;).measures(0,4)&quot;&gt;&lt;br&gt;</span>
<span class="s">Result: &lt;input type=&quot;text&quot; id=&quot;result_output&quot; size=&quot;50&quot; value=&quot;??&quot;&gt;&lt;br&gt;</span>
<span class="s">&lt;button onclick=&quot;exec_code()&quot;&gt;Execute&lt;/button&gt;</span>
<span class="s">&lt;/div&gt;</span>
<span class="s">&quot;&quot;&quot;</span>

<span class="c"># here the javascript has a function to execute the code</span>
<span class="c"># within the input box, and a callback to handle the output.</span>
<span class="n">javascript</span> <span class="o">=</span> <span class="s">&quot;&quot;&quot;</span>
<span class="s">&lt;script type=&quot;text/Javascript&quot;&gt;</span>
<span class="s">var heya = $(&#39;#heya&#39;);</span>
<span class="s">var newCanvas = $(&quot;&lt;canvas/&gt;&quot;);</span>
<span class="s">heya.append(newCanvas);</span>

<span class="s">function getData(msg) {</span>
<span class="s">       var data = handle_output(msg);</span>
<span class="s">       console.log(data);</span>
<span class="s">       data = data.slice(1, -1);</span>
<span class="s">       var jpc = new music21.jsonPickle.Converter();</span>
<span class="s">       var streamObj = jpc.run(data);</span>
<span class="s">       streamObj.replaceCanvas(&quot;#heya&quot;);</span>
<span class="s">       document.getElementById(&quot;result_output&quot;).value = streamObj._elements.length;</span>

<span class="s">}</span>


<span class="s">   function handle_output(out){</span>
<span class="s">       console.log(out);</span>
<span class="s">       var res = null;</span>
<span class="s">        // if output is a print statement</span>
<span class="s">       if(out.msg_type == &quot;stream&quot;){ // nothing to do with music21 stream</span>
<span class="s">           res = out.content.data;</span>
<span class="s">       }</span>
<span class="s">       // if output is a python object</span>
<span class="s">       else if(out.msg_type === &quot;pyout&quot;){</span>
<span class="s">           res = out.content.data[&quot;text/plain&quot;];</span>
<span class="s">       }</span>
<span class="s">       // if output is a python error</span>
<span class="s">       else if(out.msg_type == &quot;pyerr&quot;){</span>
<span class="s">           res = out.content.ename + &quot;: &quot; + out.content.evalue;</span>
<span class="s">       }</span>
<span class="s">       // if output is something we haven&#39;t thought of</span>
<span class="s">       else{</span>
<span class="s">           res = &quot;[out type not implemented]&quot;;</span>
<span class="s">       }</span>
<span class="s">       return res;</span>
<span class="s">   }</span>

<span class="s">   function exec_code(){</span>
<span class="s">       var code_input = document.getElementById(&#39;code_input&#39;).value;</span>
<span class="s">       var messagedCodeInput = &#39;vfp.fromObject(&#39; + code_input + &#39;)&#39;;</span>

<span class="s">       var kernel = IPython.notebook.kernel;</span>
<span class="s">       var callbacks = { &#39;iopub&#39; : {&#39;output&#39; : getData}};</span>
<span class="s">       document.getElementById(&quot;result_output&quot;).value = &quot;&quot;;  // clear output box</span>
<span class="s">       var msg_id = kernel.execute(messagedCodeInput, callbacks, {silent:false});</span>
<span class="s">       console.log(&quot;button pressed&quot;);</span>
<span class="s">       // IPython.notebook.clear_output();</span>
<span class="s">   }</span>
<span class="s">&lt;/script&gt;</span>
<span class="s">&quot;&quot;&quot;</span>

<span class="n">HTML</span><span class="p">(</span><span class="n">input_form</span> <span class="o">+</span> <span class="n">javascript</span><span class="p">)</span>
</pre></div>
</div>
...
</script><div class="code python highlight-python"><div class="highlight"><pre><span class="kn">import</span> <span class="nn">random</span>
<span class="k">def</span> <span class="nf">vfshow</span><span class="p">(</span><span class="n">s</span><span class="p">):</span>
    <span class="n">vfp</span> <span class="o">=</span> <span class="n">vexflow</span><span class="o">.</span><span class="n">toMusic21j</span><span class="o">.</span><span class="n">VexflowPickler</span><span class="p">()</span>
    <span class="n">vfp</span><span class="o">.</span><span class="n">mode</span> <span class="o">=</span> <span class="s">&#39;jsonSplit&#39;</span>
    <span class="n">outputCode</span> <span class="o">=</span> <span class="n">vfp</span><span class="o">.</span><span class="n">fromObject</span><span class="p">(</span><span class="n">s</span><span class="p">)</span>
    <span class="n">idName</span> <span class="o">=</span> <span class="s">&#39;canvasDiv&#39;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">random</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">10000</span><span class="p">))</span>
    <span class="n">htmlBlock</span> <span class="o">=</span> <span class="s">&#39;&lt;div id=&quot;&#39;</span> <span class="o">+</span> <span class="n">idName</span> <span class="o">+</span> <span class="s">&#39;&quot;&gt;&lt;canvas/&gt;&lt;/div&gt;&#39;</span>
    <span class="n">js</span> <span class="o">=</span> <span class="s">&#39;&#39;&#39;</span>
<span class="s">    &lt;script&gt;</span>
<span class="s">         require([&#39;music21&#39;], function() {</span>
<span class="s">           data = &#39;&#39;&#39;</span> <span class="o">+</span> <span class="n">outputCode</span> <span class="o">+</span> <span class="s">&#39;&#39;&#39;;</span>
<span class="s">           var jpc = new music21.jsonPickle.Converter();</span>
<span class="s">           streamObj = jpc.run(data);</span>
<span class="s">           streamObj.replaceCanvas(&quot;#&#39;&#39;&#39;</span> <span class="o">+</span> <span class="n">idName</span> <span class="o">+</span> <span class="s">&#39;&#39;&#39;&quot;);</span>
<span class="s">         });</span>
<span class="s">    &lt;/script&gt;</span>
<span class="s">    &#39;&#39;&#39;</span>
    <span class="k">return</span> <span class="n">HTML</span><span class="p">(</span><span class="n">htmlBlock</span> <span class="o">+</span> <span class="n">js</span><span class="p">)</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">bach</span> <span class="o">=</span> <span class="n">corpus</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&#39;bwv66.6&#39;</span><span class="p">)</span><span class="o">.</span><span class="n">measures</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">4</span><span class="p">)</span>
<span class="n">vfshow</span><span class="p">(</span><span class="n">bach</span><span class="p">)</span>
</pre></div>
</div>
<div id="canvasDiv3244"><canvas/></div>
    ...
    </script><div class="code python highlight-python"><div class="highlight"><pre><span class="n">bach</span>
</pre></div>
</div>
<div class="ipython-result highlight-python"><div class="highlight"><pre> &lt;music21.stream.Score 4412264400&gt;
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">Javascript</span><span class="p">(</span><span class="s">&#39;&#39;&#39;var n = new music21.note.Note(&quot;F#4&quot;);</span>
<span class="s">      var s = new music21.stream.Stream();</span>
<span class="s">      s.append(n);</span>
<span class="s">      var newPlace = $(&#39;div.output_subarea.output_javascript.output_pyout&#39;);</span>
<span class="s">      console.log(newPlace);</span>
<span class="s">      s.appendNewCanvas(newPlace[newPlace.length-1]);&#39;&#39;&#39;</span><span class="p">)</span>
</pre></div>
</div>
<div class="ipython-result highlight-python"><div class="highlight"><pre> &lt;IPython.core.display.Javascript at 0x107704250&gt;
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">c</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&#39;tinyNotation: 2/4 c4 d e f g a b c</span><span class="se">\&#39;</span><span class="s">&#39;</span><span class="p">)</span>
<span class="n">c</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_11_0.png" src="../_images/usersGuide_96_ipython_comm_11_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">e</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 e4 f g a b c&#39; d&#39; e&#39;&quot;</span><span class="p">)</span>
<span class="n">g</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 g4 a b c&#39; d&#39; e&#39; f&#39; g&#39;&quot;</span><span class="p">)</span>
...
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">c</span><span class="p">)</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">e</span><span class="p">)</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">g</span><span class="p">)</span>
<span class="n">sc</span> <span class="o">=</span> <span class="n">s</span><span class="o">.</span><span class="n">chordify</span><span class="p">()</span>
<span class="n">sc</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_12_0.png" src="../_images/usersGuide_96_ipython_comm_12_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">d</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 c#4 d- d# e- f# g- g# a- a# b-&quot;</span><span class="p">)</span>
<span class="n">d</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_13_0.png" src="../_images/usersGuide_96_ipython_comm_13_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">db</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 e#4 f- b# c&#39;-&quot;</span><span class="p">)</span>
<span class="n">db</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_14_0.png" src="../_images/usersGuide_96_ipython_comm_14_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">e</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 e&#39;4 f&#39; g&#39; a&#39; b&#39; c&#39;&#39; d&#39;&#39; e&#39;&#39;&quot;</span><span class="p">)</span>
<span class="n">g</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 2/4 g4 a b c&#39; d&#39; e&#39; f&#39; g&#39;&quot;</span><span class="p">)</span>
<span class="n">s</span> <span class="o">=</span> <span class="n">stream</span><span class="o">.</span><span class="n">Score</span><span class="p">()</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">c</span><span class="p">)</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">e</span><span class="p">)</span>
...
<img alt="../_images/usersGuide_96_ipython_comm_15_0.png" src="../_images/usersGuide_96_ipython_comm_15_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">r1</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 g4 g8 g g4 g8 g&quot;</span><span class="p">)</span>
<span class="n">r2</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 g8 g g g  g g g g&quot;</span><span class="p">)</span>
<span class="n">r3</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 g4   g    g   g&quot;</span><span class="p">)</span>
<span class="n">r1</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_16_0.png" src="../_images/usersGuide_96_ipython_comm_16_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">r2</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_17_0.png" src="../_images/usersGuide_96_ipython_comm_17_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">r3</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_18_0.png" src="../_images/usersGuide_96_ipython_comm_18_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">r4</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 g4 g8 g g4 g8 g   g4 g8 g g4 g8 g   g8 g g g  g g g g   g4   g    g   g    g4 g8 g g4 g8 g   g4 g8 g g4 g8 g   g8 g g g  g g g g   g4   g    g   g &quot;</span><span class="p">)</span>
<span class="n">r4</span><span class="o">.</span><span class="n">makeMeasures</span><span class="p">(</span><span class="n">inPlace</span><span class="o">=</span><span class="bp">True</span><span class="p">)</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;A&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;A&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">2</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;B&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">3</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;C&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">4</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;A&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">5</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;A&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">6</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;B&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">getElementsByClass</span><span class="p">(</span><span class="s">&#39;Measure&#39;</span><span class="p">)[</span><span class="mi">7</span><span class="p">]</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;C&quot;</span>
<span class="n">r4</span><span class="o">.</span><span class="n">__class__</span> <span class="o">=</span> <span class="n">stream</span><span class="o">.</span><span class="n">Part</span>
<span class="n">r4</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_20_0.png" src="../_images/usersGuide_96_ipython_comm_20_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">c</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 C1 G&quot;</span><span class="p">)</span>
<span class="n">e</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 E1 B&quot;</span><span class="p">)</span>
<span class="n">g</span> <span class="o">=</span> <span class="n">converter</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&quot;tinyNotation: 4/4 G1 d&quot;</span><span class="p">)</span>
<span class="n">s</span> <span class="o">=</span> <span class="n">stream</span><span class="o">.</span><span class="n">Score</span><span class="p">()</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">c</span><span class="p">)</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">e</span><span class="p">)</span>
<span class="n">s</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">g</span><span class="p">)</span>
<span class="n">sc</span> <span class="o">=</span> <span class="n">s</span><span class="o">.</span><span class="n">chordify</span><span class="p">()</span>
<span class="n">sc</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">clef</span><span class="o">.</span><span class="n">BassClef</span><span class="p">())</span>
<span class="n">sc</span><span class="o">.</span><span class="n">flat</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;I&quot;</span>
<span class="n">sc</span><span class="o">.</span><span class="n">flat</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span><span class="o">.</span><span class="n">lyric</span> <span class="o">=</span> <span class="s">&quot;V&quot;</span>
<span class="n">sc</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_21_0.png" src="../_images/usersGuide_96_ipython_comm_21_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">I</span> <span class="o">=</span> <span class="n">sc</span><span class="o">.</span><span class="n">flat</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span>
<span class="n">V</span> <span class="o">=</span> <span class="n">sc</span><span class="o">.</span><span class="n">flat</span><span class="o">.</span><span class="n">notes</span><span class="p">[</span><span class="mi">1</span><span class="p">]</span>
<span class="kn">from</span> <span class="nn">copy</span> <span class="kn">import</span> <span class="n">deepcopy</span>
<span class="n">sc3</span> <span class="o">=</span> <span class="n">stream</span><span class="o">.</span><span class="n">Part</span><span class="p">()</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">clef</span><span class="o">.</span><span class="n">BassClef</span><span class="p">())</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">meter</span><span class="o">.</span><span class="n">TimeSignature</span><span class="p">(</span><span class="s">&#39;4/4&#39;</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">V</span><span class="p">))</span>

<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">V</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">deepcopy</span><span class="p">(</span><span class="n">I</span><span class="p">))</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">makeMeasures</span><span class="p">(</span><span class="n">inPlace</span> <span class="o">=</span> <span class="bp">True</span><span class="p">)</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">measure</span><span class="p">(</span><span class="mi">4</span><span class="p">)</span><span class="o">.</span><span class="n">rightBarline</span> <span class="o">=</span> <span class="s">&#39;double&#39;</span>
<span class="n">sc3</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_22_0.png" src="../_images/usersGuide_96_ipython_comm_22_0.png" />
<div class="code python highlight-python"><div class="highlight"><pre><span class="nb">all</span> <span class="o">=</span> <span class="n">stream</span><span class="o">.</span><span class="n">Score</span><span class="p">()</span>
<span class="nb">all</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">r4</span><span class="p">)</span>
<span class="nb">all</span><span class="o">.</span><span class="n">insert</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">sc3</span><span class="p">)</span>
<span class="nb">all</span><span class="o">.</span><span class="n">show</span><span class="p">(</span><span class="s">&#39;musicxml&#39;</span><span class="p">)</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="kn">import</span> <span class="nn">random</span>
<span class="n">random</span><span class="o">.</span><span class="n">randint</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span><span class="mi">20</span><span class="p">)</span>
</pre></div>
</div>
<div class="ipython-result highlight-python"><div class="highlight"><pre> <span class="mi">12</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="kn">from</span> <span class="nn">os.path</span> <span class="kn">import</span> <span class="n">expanduser</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">home</span> <span class="o">=</span> <span class="n">expanduser</span><span class="p">(</span><span class="s">&quot;~&quot;</span><span class="p">)</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">home</span>
</pre></div>
</div>
<div class="ipython-result highlight-python"><div class="highlight"><pre> <span class="s">&#39;/Users/cuthbert&#39;</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">c</span> <span class="o">=</span> <span class="n">corpus</span><span class="o">.</span><span class="n">parse</span><span class="p">(</span><span class="s">&#39;luca/gloria&#39;</span><span class="p">)</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="nb">len</span><span class="p">(</span><span class="n">c</span><span class="p">)</span>
</pre></div>
</div>
<div class="ipython-result highlight-python"><div class="highlight"><pre> <span class="mi">13</span>
</pre></div>
</div>
<div class="code python highlight-python"><div class="highlight"><pre><span class="n">c</span><span class="o">.</span><span class="n">measures</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">40</span><span class="p">)</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
</pre></div>
</div>
<img alt="../_images/usersGuide_96_ipython_comm_31_0.png" src="../_images/usersGuide_96_ipython_comm_31_0.png" />
